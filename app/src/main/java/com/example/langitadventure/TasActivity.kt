...
class TasActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView1 = findViewById(R.id.recyclerViewTas)
        recyclerView1.layoutManager = GridLayoutManager(this@TasActivity, 2)
        ...
        firestore.collection("items")
            ...
            .addOnSuccessListener { documents ->
                ...
                for (document in documents) {
                    ...
                    Log.d("TasActivity", "namaBarang: $namaBarang, hargaPerMalam: $hargaPerMalam, gambarBarang: $gambarBarang, availability: $availability, bookingCount: $bookingCount, category: $category, description: $description")
            ...
            .addOnFailureListener { exception ->
                Log.e("TasActivity", "Error fetching data: ", exception)
            }
    }
}