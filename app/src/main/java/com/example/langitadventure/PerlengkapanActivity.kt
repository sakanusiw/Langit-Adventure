...
class PerlengkapanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView1 = findViewById(R.id.recyclerViewPerlengkapan)
        recyclerView1.layoutManager = GridLayoutManager(this@PerlengkapanActivity, 2)
        ...
        firestore.collection("items")
            ...
            .addOnSuccessListener { documents ->
                ...
                for (document in documents) {
                    ...
                    Log.d("PerlengkapanActivity", "namaBarang: $namaBarang, hargaPerMalam: $hargaPerMalam, gambarBarang: $gambarBarang, availability: $availability, bookingCount: $bookingCount, category: $category, description: $description")
            ...
            .addOnFailureListener { exception ->
                Log.e("PerlengkapanActivity", "Error fetching data: ", exception)
            }
    }
}